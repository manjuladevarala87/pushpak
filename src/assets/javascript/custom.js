$(document).ready(function () {
    ...
    //     if ($(window).width() < 0) {
    //         $('body').toggleClass('sidebarmenu-hide');
    //     }
    //     else {
    //         $('.sidebar').toggleClass('sidebar-active');
    //         $('.menuback-drop').toggle();
    ...
    // $('.menuback-drop').click(function () {
    //     $('.sidebar').removeClass('sidebar-active');
    //     $('.menuback-drop').hide();
    // });
	
	
    $('.ibox-collapse-link').click(function () {
        $('.ibox-content').slideToggle();
        $('.ibox-collapse-link').toggleClass('minus-expanded');
    });
});

function fncViewOrderList() {
    $('.ibox-content').slideToggle();
    $('.ibox-collapse-link').toggleClass('minus-expanded');
    $('.vieworder-list-block').show();
}
// if($(window).width() < 999) {
// 	$('.sidebar').addClass('active');
// }
function fncReportRange(id, current) {
    $('.RRDiv').hide();
    $('.ctgactive').removeClass('ctgactive');
    $('#' + id).slideToggle();
    $(current).addClass('ctgactive');
}
...
//     $('.sidebar, .iconMenu').click(function(event){
...
$(".iconMenu").click(function(){
	...
	if ($(window).width() > 999) {
		$(".header-container").css("padding-left", "134px");
	}else{ $(".sidebar .close").css("display", "block");
	...
	$(".sidebar").addClass("active");
	$(".header-container").css("padding-left", "15px");
	$(".page-wrapper").css("padding-left", "0px");
	}css
	})
	$(".sidebar .close").click(function(){
		...
		// $(".header-container").css("padding-left", "10px");
		})
		// $('body').click(function() {
		// $(".sidebar").addClass("active");
		// $(".header-container").css("padding-left", "15px");
